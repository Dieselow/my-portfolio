            ...
            <div  className="focus:outline-none">
                <div className="mx-auto container pb-8 mt-12">
                    <div className="flex flex-wrap items-center lg:justify-between justify-center">
                        <div tabIndex={0} className="focus:outline-none mx-2 w-72 xl:mb-0 mb-8 card">
                            <div>
                            ...
                            <div className="bg-white">
                                <div className="flex items-center justify-between px-4 pt-4">
                                    <svg xmlns="http://www.w3.org/2000/svg" tabIndex={0} className="focus:outline-none"
                                ...
                                <div className="p-4">
                                    <div className="flex items-center">
                                        <h2 tabIndex={0} className="focus:outline-none text-lg font-semibold">iphone
                                            XS</h2>
                                        <p tabIndex={0} className="focus:outline-none text-xs text-gray-600 pl-5">4 days
                                            ago</p>
                                    </div>
                                    <p tabIndex={0} className="focus:outline-none text-xs text-gray-600 mt-2">The Apple
                                        iPhone XS is available in 3 colors with 64GB memory. Shoot amazing videos</p>
                                ...
                                <div className="flex items-center justify-between px-4 pt-4">
                                    <div>
                                        <svg xmlns="http://www.w3.org/2000/svg" tabIndex={0}
                                             className="focus:outline-none" width="20" height="20" viewBox="0 0 24 24"
